...
<div class="form">
  <div class="form-content">
    <p class="list-title">Follower List</p>
    <div class="follows-icon-list">
      @foreach($follower_ids as $follower_ids)
        <a href="/profile/{{$follower_ids->id}}"><img class="icon" src="{{asset('storage/images'.$follower_ids->images)}}"></a>
      @endforeach
    </div>
  </div>
</div>
